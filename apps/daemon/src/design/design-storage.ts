...
export const listDesignMainSessions = ledgerState.listDesignMainSessions;
export const createDesignMainSession = ledgerState.createDesignMainSession;
export const activateDesignMainSession = ledgerState.activateDesignMainSession;
export const renameDesignMainSession = ledgerState.renameDesignMainSession;
export const deleteDesignMainSession = ledgerState.deleteDesignMainSession;
