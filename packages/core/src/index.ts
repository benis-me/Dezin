...
export type {
  ...
  WorkspaceGenerationArtifactPrototypeRequirements,
  ...
  WorkspaceGenerationPrototypeSourceRequirement,
  WorkspaceGenerationPrototypeTargetRequirement,
...
export {
  GENERATION_TASK_PROTOTYPE_FINALIZATION_PROTOCOL,
  ...
  type BuildGenerationTaskPrototypeFinalizationResultInput,
  type BuildGenerationTaskPrototypeValidationInput,
  type GenerationTaskPrototypeFinalizationBinding,
  type GenerationTaskPrototypeFinalizationPreparation,
  type GenerationTaskPrototypeFinalizationRequirement,
